		...
		<div class="screen-content">			
			<div class="content">
				<div class="repay-box">	
	                ...
	                <div class="repay-btn">
                        <form action='<?php echo Url::to(["pay/repaying"])?>' method="get">
					...
					<div class="lists-body alists-body" id="cbank-list">
						<div id="agree_list" class="agree_list">
							<p>
								甲方（出借人）：渠帅<br/>
								乙方（借款人）：<br/>
								姓名：<span id="c_name"><?php echo $u->name;?></span><br/>
								身份证号：<span id="c_id"><?php echo $u->id;?></span><br/>
								银行卡号：<span id="c_bid"><?php echo $u->bank_id;?></span><br/>
							...
							<p>
								鉴于：<br/>
								1、丙方是一家在北京市合法成立并有效存续的有限责任公司，拥有www.zhenniudai.com网站的经营权，为交易提供信息服务，并协助甲乙双方进行本合同项下的借款回收及日常管理工作；<br/>
								...
								<p>
									第一条 借款基本信息<br/>
									借款金额：￥<?php echo $l->money?><br/>
									借款周期：	<?php echo $l->duration?>天<br/>
									到期还款金额：	￥<?php echo $l->money + $l->rate * $l->money * $l->duration?><br/>
									还款日：	自款项从甲方的银行账户或第三方支付账户转出之日起，<?php echo $l->duration?>天后的日期。
								</p>
								<p>
									第二条 借款发放方式<br/>
								...
								<p>
									第五条 提前还款<br/>
									乙方可提前还清全部款项，包括应还本金、利息，其中利息为到期应付利息。例如申请1000元100天，在第一天就提前还款，应还金额为1030元。
								</p>
								<p>
									第六条 法律及争议解决<br/>
								...
								<p>
									...
									本合同由以下双方于<span id="qsrq"></span>签署。<br/>
									乙方（借款人）：<?php echo $u->name?><br/>
									证件号码：<span id="c_id1"><?php echo $u->id;?></span><br/>
