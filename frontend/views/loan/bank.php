					 ...
					 <form class="forms" id="form2" action='<?php echo Url::to(["loan/success"])?>' method='post'>				                                   
		            	<div class="forms-item">
			                ...
			                <div class="forms__group">
			                    ...
			                    <span class="input__box">             
			                        <input type="tel" class="forms_input" placeholder="银行卡号" value="" id="bc-num" name="bank_id">
			            ...
			            <div class="forms-item">
			                ...
			                <div class="forms__group">
			                    ...
			                    <span class="input__box no-border">   
			                        <input type="tel" class="forms_input" placeholder="预留在银行的手机号"  id="phone-num" name="mobile">
...
<div class="mask9" style="position:fixed;left:0;top:0;display:none;">
	<div class="popover popover-big" style="display:block;position: relative;left:0;" id="agreement">
		<div class="popover-inner">
			<div class="lists-box">					
				<div class="lists-title">
					<h3>借款协议</h3>
					...
					<div class="lists-main" style="max-height:300px;" id="agree_list">
						...
						<p>
							...
							<p>
								...
								借款周期： <?php echo $loan->duration;?><br/>
								到期还款金额：￥<?php echo ($loan->money+$loan->money*$loan->duration);?><br/>
							...
							<p>
								...
								5.乙方不得将本协议项下的任何权利义务转让给任何其他方。<br/><br/>
