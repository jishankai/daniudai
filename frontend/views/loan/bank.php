...
<link rel="stylesheet" type="text/css" media="all" href="css/css_new/reset.css" />
<link rel="stylesheet" type="text/css" media="all" href="css/css_new/base.css" />
<link rel="stylesheet" type="text/css" media="all" href="css/css_new/fonts.css" />
<link rel="stylesheet" type="text/css" media="all" href="css/css_new/widget.css" />
					...
					<form class="forms" id="form2" action="" onsubmit="return false;">				                                   
			            ...
			            <div class="forms-item" style="display:none;" id="imbox">	
			                ...
			                <div class="forms-item agreement active" style="display:block;" id="agreement-btn">
			            		<p class="text"><i class="icons icons-checkNew"></i>同意接受&nbsp;<a href="javascript:;">相关协议</a></p>      	
			            	</div>	
		                </div>
