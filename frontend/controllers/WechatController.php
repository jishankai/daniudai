        ...
        $server->on('message', function($message) {
            if ($message->MsgType=='text') {
                if ($message->Content=='借款') {
                    ...
                    return Message::make('text')->content('真牛贷对在校生提供1000—10000元的无抵押、纯信用贷款，利率为0.03%/日。只要是大学生，注册提交并面签通过后，最快10分钟内拿到借款。借款期限为100天、200天、300天，到期再还款。真牛贷希望你能在这段时间内自己赚钱，来还这笔钱，而不是从父母给的生活费里出。
